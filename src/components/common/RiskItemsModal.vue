    ...
    <Teleport to="body">
      <Transition name="modal">
        ...
        >
          ...
          >
            <!-- Header -->
            <div class="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 px-4 py-4 sm:px-6 flex-shrink-0">
              <div class="flex items-center justify-between">
              ...
              <div class="mt-3 relative">
                <input
                  ...
                  class="w-full px-3 py-2 pl-10 border border-gray-300 dark:border-gray-600 rounded-md focus:ring-2 focus:ring-primary focus:border-primary bg-white dark:bg-gray-700 text-gray-900 dark:text-white"
                />
                <svg class="w-5 h-5 absolute left-3 top-1/2 -translate-y-1/2 text-gray-400 dark:text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="flex-1 overflow-y-auto px-4 py-2 sm:px-6">
              <div v-if="filteredOptions.length === 0" class="py-12 text-center text-sm text-gray-500 dark:text-gray-400">
                No items found
              </div>
              ...
              <label
                ...
                :class="{ 'bg-primary/5 dark:bg-primary/10': isSelected(option.id) }"
              >
                <!-- Checkbox -->
                <input
                  type="checkbox"
                  ...
                  class="w-5 h-5 mt-0.5 text-primary border-gray-300 dark:border-gray-600 rounded focus:ring-primary flex-shrink-0"
                />
                ...
                <div class="flex-1 min-w-0">
                  ...
                  <div class="flex items-center gap-2 mt-1">
                    <span v-if="option.category" class="text-xs px-2 py-0.5 bg-gray-100 dark:bg-gray-700 text-gray-600 dark:text-gray-400 rounded">
                      {{ option.category }}
                    </span>
            ...
            <!-- Footer -->
            <div class="bg-white dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700 px-3 py-2.5 flex gap-2 flex-shrink-0">
              <button
                type="button"
                @click="showAddModal = true"
                class="px-3 py-2 border border-primary text-primary rounded-md hover:bg-primary/10 dark:hover:bg-primary/20 text-sm font-medium flex items-center gap-1.5"
              >
    ...
    <Teleport to="body">
      <Transition name="modal">
        ...
        >
          ...
          <!-- Add Modal Content -->
          <div
            class="relative bg-white dark:bg-gray-800 w-full max-w-md rounded-lg shadow-xl z-10 p-6"
            @touchmove.stop
          >
            <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-4">Add New Risk Item</h3>
            ...
            <div class="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md focus:ring-2 focus:ring-primary focus:border-primary bg-white dark:bg-gray-700 text-gray-900 dark:text-white"
                />
              </div>
            ...
            <div class="mt-6 flex gap-2">
              ...
              <button
                ...
                class="flex-1 px-3 py-2 bg-primary text-white rounded-md hover:bg-primary-hover text-sm font-medium disabled:opacity-50 disabled:cursor-not-allowed"
              >
                Add Item
              </button>
            </div>
...
const filteredOptions = computed(() => {
  ...
  if (selectedCategory.value) {
    filtered = filtered.filter((opt: any) => opt.category === selectedCategory.value)
  }
...
const getCountByCategory = (category: string) => {
  return props.options.filter((opt: any) => opt.category === category).length
}

// Get option label by ID
const getOptionLabel = (id: string) => {
  const option = props.options.find((opt: any) => opt.id === id)
  return option ? (option as any).name : ''
}
